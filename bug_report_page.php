...
if( $f_master_bug_id > 0 ) {
	...
	$f_category_id			= gpc_get_int( 'category_id', 0 );
        //echo "f_category_id: ".$f_category_id;
...
//echo "t_show_category: ".$t_show_category."<br>";
$t_show_reproducibility = in_array( 'reproducibility', $t_fields );
//echo "t_show_reproducibility: ".$t_show_reproducibility."<br>";
$t_show_eta = in_array( 'eta', $t_fields );
//echo "t_show_eta: ".$t_show_eta."<br>";
$t_show_severity = in_array( 'severity', $t_fields );
//echo "t_show_severity: ".$t_show_severity."<br>";
...
$t_show_tags =
	...
	access_has_project_level(
		...
		$t_project_id );
//echo "t_show_tags: ".$t_show_tags."<br>";
...
//echo "t_show_due_date: ".$t_show_due_date."<br>";
if( $t_show_due_date ) {
