 ...
 */
$g_hostname				= 'localhost:8081';
//$g_hostname				= HOST;
#$g_hostname='172.16.34.64:8080'
/**
 ...
 */
 /*
 Permite la creación de cuentas "Crear cuenta" desde la pagina de login
 */
$g_allow_signup			= OFF;
 ...
 */
#$g_webmaster_email		= 'soportemgms@gmail.com';
$g_webmaster_email		= 'mail@mgms.com.co';

/**
 * the sender email, part of 'From: ' header in emails
 * @global string $g_from_email
 */
$g_from_email			= 'mail@mgms.com.co';

/**
 * the sender name, part of 'From: ' header in emails
 * @global string $g_from_name
 */
$g_from_name			= 'Soporte MGM';

/**
 * the return address for bounced mail
 * @global string $g_return_path_email
 */
$g_return_path_email	= 'mail@mgms.com.co';
 ...
 *
 Habilitar el soporte para iniciar sesión por correo electrónico y contraseña, además de
 * nombre de usuario y contraseña. Esto sólo funcionará siempre y cuando haya una sola
 * Usuario con la dirección de correo electrónico especificada y la dirección de correo electrónico no está en blanco.
 ...
 */
#$g_smtp_username = 'soportemgms@gmail.com';
$g_smtp_username = 'mail@mgms.com.co';
 ...
 */
#$g_smtp_password = 'DV%r*zjqjuKtaktzyS'; # contraseña correo GMAIL
$g_smtp_password = 'Redcom2016*';
 ...
 */
$g_smtp_connection_mode = 'STARTTLS';
 ...
 */
$g_fallback_language = 'America/Bogota';
 ...
 */
 /*
 wavargas
 Mostrar Documentos en el menu principal
 */
 ...
 * @global integer $g_show_project_menu_bar
 wavargas
 Mostrar una barra adicional sobre el menu; donde muestra todos los proyectos creados.
 */
 ...
 */
 /*
 wavargas
 Mostrar la prioridad "texto" en vez de la imagen (icono).
 */
 ...
 * @global array $g_view_issues_page_columns
 ...
 Columnas que se muestran en la opción "Ver incidencias"
 ...
 */
 /*
 wavargas
 Muestra el nombre real del usuario en las incidencias.
 */
$g_show_realname = OFF;
 ...
 */
 ...
 Define la visibilidad del proyecto; lo recomendable es privado.
 */
 ...
 */
$g_absolute_path_default_upload_folder = '.\anexos/';
 ...
 */
/**
 * Permiso para eliminar archivos adjuntos a la incidencia
 */
//$g_delete_attachments_threshold = ADMINISTRATOR;
$g_delete_attachments_threshold = NOBODY;
 ...
 * @global array $g_bug_report_page_fields
 wavargas
Campos solicitados en el momento de la creación de una incidencia.
 ...
 */
$g_update_bug_threshold = ADMINISTRATOR;
 ...
 */
$g_view_proj_doc_threshold = ADMINISTRATOR;

/**
 * Site manager
 * @global integer $g_manage_site_threshold
 */
$g_manage_site_threshold = ADMINISTRATOR;
 ...
 */
 #wavargas: permite administrar los proyectos
 ...
 */
$g_project_user_threshold = ADMINISTRATOR;
...
#wavargas: permite administrar usuarios
 ...
 * Umbral necesario para suplantar a un usuario o NOBODY para desactivar la función.
 */
 ...
 */
$g_update_readonly_bug_threshold = ADMINISTRATOR;
 ...
 */
$g_update_bug_status_threshold = ADMINISTRATOR;
 ...
 * Permitir que un error no tenga categoría (aplicación)
 */
 ...
 */
 //wavargas actualizar incidencias
$g_allow_reporter_upload = OFF;
...
# WAVARGAS: ADMINISTRA CONFIGURACIÓN DE LA APLICACIÓN
#$g_manage_configuration_threshold = ADMINISTRATOR;
$g_manage_configuration_threshold = NOBODY;
...
#$g_view_configuration_threshold = NOBODY;
...
#$g_set_configuration_threshold = NOBODY;
 ...
 */
 /*wavargas
 Color por estado en las incidencias*/
$g_status_colors = array(
	'new'          => '#fcbdbd', # red    (scarlet red #ef2929)
	'feedback'     => '#e3b7eb', # purple (plum        #75507b)e3b7eb
	'acknowledged' => '#ffd850', # orange (orango      #f57900)
	'confirmed'    => '#F18C00', # yellow (butter      #fce94f)fff494
	'assigned'     => '#6FB6CC', # blue   (sky blue    #729fcf)c2dfff
	'resolved'     => '#cceedd', # green  (chameleon   #8ae234) d2f5b0
 ...
 */
$g_priority_enum_string = '10:none,20:low,30:normal,40:high,60:immediate';
/**
 *
...
$g_reproducibility_enum_string = '0:,10:Datos,20:Desarrollo';
 ...
 * @global integer $g_time_tracking_enabled
 Activar la contabilidad de seguimiento de tiempo
 wavargas
 ...
 * @global integer $g_time_tracking_stopwatch
 Cronómetro para construir el tiempo de seguimiento del campo
 wavargas
 */
 ...
 */
$g_due_date_update_threshold = ADMINISTRATOR;

/**
 * threshold to see due date
 * @global integer $g_due_date_view_threshold
 */
$g_due_date_view_threshold = ADMINISTRATOR;
 ...
 */
$g_subprojects_inherit_categories = OFF;
...
#$g_log_destination = 'file:.\logs/mantis_logall.log';
